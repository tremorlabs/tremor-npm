...
export interface DatepickerProps {
  ...
  handleChangeEndDay?: { (selectedEndDay: Date | null): void };
...
const Datepicker = ({
  ...
  handleChangeEndDay = (selectedEndDay: Date | null) => null,
  ...
  useEffect(() => {
    if (selectedStartDay && selectedEndDay)
      handleSelect(selectedStartDay, selectedEndDay);
  }, [selectedEndDay]);
  ...
  useEffect(() => {
    handleChangeEndDay(selectedEndDay);
  }, [selectedEndDay]);
        ...
        {enableRelativeDates ? (
          <button
            ...
            className={classNames(
              ...
              getColorVariantsFromColorThemeValue(
                defaultColors.canvasBackground
              ).hoverBgColor,
              getColorVariantsFromColorThemeValue(defaultColors.border)
                .borderColor,
              getColorVariantsFromColorThemeValue(defaultColors.ring)
        ...
        >
          ...
          >
            <button
              type="button"
              onClick={() =>
                previousMonth(firstDayCurrentMonth, setCurrentMonth)
              }
              className={classNames(
