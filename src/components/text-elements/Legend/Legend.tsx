    ...
    return (
        <button
            className={tremorTwMerge(
                ...
                // light
                disabled ? "text-tremor-content-subtle" : "text-tremor-content hover:text-tremor-content-emphasis hover:bg-tremor-background-subtle",
                // dark
                disabled ? "dark:text-dark-tremor-subtle" : "dark:text-dark-tremor dark:hover:text-tremor-content-emphasis dark:hover:bg-dark-tremor-background-subtle",
            )}
            disabled={disabled}
            onClick={(e) => {
                e.stopPropagation();
        ...
        >
            <div
                ...
                className={tremorTwMerge(
                    //common 
                    "h-full flex",
                    allowScroll ? "pl-4 pr-12  items-center overflow-auto snap-mandatory [&::-webkit-scrollbar]:hidden [scrollbar-width:none]" : "flex-wrap",
                )}
            >
