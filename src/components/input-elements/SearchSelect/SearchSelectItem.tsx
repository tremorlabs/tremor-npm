  ...
  return (
    <Combobox.Option
      className={tremorTwMerge(
        ...
        "flex justify-start items-center hover:bg-tremor-background-muted ui-active:bg-tremor-background-muted ui-active:text-tremor-content-strong ui-selected:bg-tremor-background-muted",
